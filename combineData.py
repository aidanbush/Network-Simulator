...
dataPattern = re.compile("^(.+)_Flow(\d+)_(ECNAverages|Rate|RateChange|Reward|MultAction|AddAction|MultMean|MultStdev|AddMean|AddStdev|DroppedPackets|Throughput|MinRTT|AverageRTT|PacketsArrived|AcksArrived|SentRate|ErroredPackets|SentPackets|Goodput|HopRatio).csv$")

DATA_TYPES = ["ECNAverages", "Rate", "RateChange", "Reward", "MultAction", "AddAction", "MultMean", "MultStdev", "AddMean", "AddStdev", "DroppedPackets", "Throughput", "MinRTT", "AverageRTT", "PacketsArrived", "AcksArrived", "SentRate", "ErroredPackets", "SentPackets", "Goodput", "HopRatio"]
